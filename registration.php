...
<head>
    ...
    <title>Регистрация | Газпром Сеть АЗС Белореченск</title>
        ...
        <div class="container">
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-xl-9">
                    ...
                    <h6 class="text-white mb-4">Уже есть учетная запись? <a href="login.php">Войти</a></h6>

                    <div class="card" style="border-radius: 15px;">
                        <form action="service/do_register.php" method="post">
                            <?php flash(); ?>
                            <div class="card-body">
                                ...
                                <div class="row align-items-center pt-4 pb-3">
                                    ...
                                    <div class="col-md-9 pe-5">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="patronymic" />
